...
<title>Suggest Home-Remedy</title>
</head>
...
if(name1=='a'){
 alert('Click on "Medicine" on Next Page to read home remedy...');
}
		else if(name1=='b'){
		 alert('Click on "BodyAche" on Next Page to read home remedy......');
		 }
		else if(name1=='c'){
		 alert('Click on "Stomachache" on Next Page to read home remedy...');
		 }
		else if(name1=='d'){
	 alert('Click on "Dental pain" on Next Page to read home remedy...');
 			}
				else if(name1=='e'){
	 alert('Click on "Dental Pain" on Next Page to read home remedy...');
 			}
...
<table class="table table-hover table-dark">
  <thead>
    <tr>
      ...
      <th scope="col" class="text-center text-warning">Home - Remedies</th>

    </tr>
  </thead>

<tr><th class="text-center"><a href=#>Medicine</a></th></tr>
<tr><th class="text-center"><a href=#>Orthopedic</a></th></tr>
<tr><th class="text-center"><a href=#>Dental Pain</a></th></tr>
<tr><th class="text-center"><a href=#>Cardiac electrophysiologist</a></th></tr>
<tr><th class="text-center"><a href=#>Cardiologist</a></th></tr>
<tr><th class="text-center"><a href=#>Stomach Ache</a></th></tr>
<tr><th class="text-center"><a href="#">BodyAche</a></th></tr>
<br><br>
