...
<head><title>Self-Diagnosis</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Life-Care</strong></a>
    </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="pic/2.jpg" alt="img1" width="1200" height="600">

      </div>

      <div class="item">
        <img src="pic/12.jpg" alt="img2" width="800" height="300">
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">Life-Care</h3>
